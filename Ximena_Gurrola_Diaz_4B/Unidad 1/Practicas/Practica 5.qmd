...
# se crearían nuevas instancias cada vez y ya no sería único, perdería el patrón Singleton.

#2 Que significa el true en p1 is p2 is p3 en el contexto del patron singleton
# p1 is p2 is p3 da True porque los tres nombres apuntan al mismo objeto en memoria.

#3 Es buena idea usar el metodo singelton para todo lo que sea global? menciona ejemplos donde sea recomendable y donde no
# No es buena idea usar Singleton para todo, se podria usar cuando solo debe existir uno, como un logger 
# una conexión a la base de datos, no en cosas que necesitan varias copias, como usuarios, productos, pedidos.